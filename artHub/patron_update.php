<?php
	/* ---------------------------------------------------------------------------
	* filename    : patron_update.php
	* description : allows user to update a patron.
	* ---------------------------------------------------------------------------
	*/
    ...
    if ( !empty($_POST)) {
        ...
        if ($valid) {
            ...
            $sql = "UPDATE patrons  set name = ?, email = ? WHERE id = ?";
            $q = $pdo->prepare($sql);
...
<body>
    <div class="container">
                ...
                <div class="span10 offset1">
                    <div class="row">
                        <h3>Update a Patron</h3>
                    </div>
             
                    <form class="form-horizontal" action="patron_update.php?id=<?php echo $id?>" method="post">
